...
test.describe('OV1_05_Create_EU_Product', () => {
    test('OV1_05', async ({ page }) => {
        ...
        const supplierId = getData('supplierId(EU)');
        ...
        await ui.inputSelector('input[id*="UnitOfMeasureConversionStandard_Factor_input"]', "25");
